...
import { Navbar, Nav, Button, Container, Row, Col, Placeholder , Form } from "react-bootstrap";
import { Link } from "react-router-dom";
import { Combobox } from "react-widgets";

function MembershipFeesVerification(){
    return(
        ...
        <div className="subDiv">
          ...
          >
            <Col className="col-md-4">
              <h4 className="color">Select Association :</h4>
            ...
            <Col className="col-md-4">
              <h4 style={{textAlign:""}} className="color">Status :</h4>
              <Combobox
...
export default MembershipFeesVerification;