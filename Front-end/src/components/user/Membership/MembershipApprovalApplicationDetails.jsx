...
function MembershipApprovalApplicationDetails() {
  return (
    <div
    ...
    >
      ...
      <div
        ...
        style={{ padding: "60px", paddingBottom: "20px" }}
      >
        <Row className="">
          {" "}
          <h4 className="main-heading" style={{ justifyContent: "left" }}>
            Application Details
          </h4>{" "}
        </Row>
      </div>
      ...
      {/*<div
        className="container-fluid d-flex"
        style={{ padding: "60px", paddingBottom: "20px", paddingTop: "2px" }}
      >
        <Row className="">
          {" "}
          <h4 className="main-heading" style={{ justifyContent: "left" }}>
      ...
      <Container className="container-fluid">
        {/*<Row className="align-items-center">
          ...
          >
            <h4 className="color" style={{ marginRight: "10px" }}>
              Certificate
            </h4>
        ...
        <Row className="" style={{ paddingTop: "12px" }}>
          <Col md={3}>
            <h4 className="color">Remarks of Verifier:</h4>
            <textarea></textarea>
          </Col>
        </Row>
        <Row className="" style={{ paddingTop: "12px" }}>
          <Col md={3}>
            <h4 className="color">Remarks of Secretary:</h4>
            <textarea></textarea>
          </Col>
          <Col md={1} className="text-center">
            <h4 className="color"></h4>
...
export default MembershipApprovalApplicationDetails;
